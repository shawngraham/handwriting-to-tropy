...
# get PIL too: pip install pillow
...
try:
    ...
    os.environ['COMPUTER_VISION_SUBSCRIPTION_KEY']='2586ed9920f84529b671ce8bdaaa04ee'
    os.environ['COMPUTER_VISION_ENDPOINT']='https://test-for-nature.cognitiveservices.azure.com/'
